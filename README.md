...
This plugin adds Arabic translations to the WonderCMS admin area, based on `https://github.com/StephanStanisic/zlanguage-nl_NL` (experimental version).
<!--
...
## How this works
The translations are all in the ar.csv file.      
